...
@section('title')
    <title>Ask Question | ASK Me</title>
@endsection
                ...
                <form action="{{ route('user.postQuestion') }}" method="post" id="post-question" enctype="multipart/form-data">
                    ...
                    <div class="form-inputs clearfix">
                        ...
                        <p>
                            ...
                            <span class="form-description">Please choose suitable tags. Ex: <span class="color">grammar,vocab</span></span>
                        </p>
                        <p>
                            <label>Schedule</label>
                            <input name="datetime" type="text" id="datetime-picker">
                            <span class="form-description">Schedule to post question later.</span>
                        </p>
                    </div>
